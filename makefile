...
vpg4s:		vpg4q.o solsq.o getadq.o calcu.o\
	...
	gcc  -ovpg4s2 \
		...
		-lncurses  -lm  -lform -lpthread $(MYSQL)
#	chown root vpg4s
#	chmod u+s vpg4s
	mv vpg4s2 bin
...
vpg4q.o:	vpg4s.c vsqrun.c archisq.h
		gcc -c -DDEBUG -DSS_UNIX -DSQLGEN -ovpg4q.o vpg4s.c $(MYSQL)

solsq.o:	solsq.c archisq.h
		gcc -c -DDEBUG -DSS_UNIX solsq.c  $(MYSQL)

getadq.o:	getad.c archisq.h
		gcc -c -DDEBUG -DSS_UNIX -DSQLGEN -ogetadq.o getad.c $(MYSQL)

getad.o:	getad.c
		gcc -c -DVSAMD getad.c $(MYSQL)

vpg4v.o:	vpg4s.c vsamrun.c
		gcc -c -DDEBUG -DVSAMD -ovpg4v.o vpg4s.c
...
consulmysql:	consulmysql.c  solsq.o
	gcc -o consulmysql -c consulmysql.c solsq.o $(MYSQL)
#		gcc -c -DDEBUG -DSS_UNIX solsq.c  $(MYSQL)
